...
from image_utils import plot_bbox, fig_to_pil, draw_polygons, draw_ocr_bboxes
from schemas.parsed_data import responseDocument
...
if __name__ == "__main__":
    ...
    img = PILImage.open("/Users/pranaviyer/tinytext/infra/fastapi_app/routers/document_parsing/marker/output/IEC_WindSiting_Best Practices_Oct_2019/0_image_1.png")
    ...
    results = process_image_task(img, task_prompt, shared_state)
    print(results)
